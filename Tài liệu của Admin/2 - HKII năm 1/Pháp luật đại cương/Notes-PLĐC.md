...
Giảng viên: cô Thùy Liên.

Điểm thành phần:
-
- Thi GK: %, thuyết trình theo nhóm và chủ đề đã chọn.
- Thi CK: %
Có phát biểu, trả lời câu hỏi (của cô hay của nhóm thuyết trình) thì được ghi nhận lấy điểm cộng.
...
- Chủ đề 2: Tìm hiểu về Viện kiểm sát và Tòa án.
- Chủ đề 3:
- Chủ đề 4:
- Chủ đề 5: Tìm hiểu nội dung về Quy phạm pháp luật.
- Chủ đề 6: Tìm hiểu nội dung về Quan hệ pháp luật.
- Chủ đề 7:
- Chủ đề 8: Tìm hiểu nội dung về trách nhiệm pháp lý.
- Chủ đề 9:
- Chủ đề 10: Tìm hiểu nội dung về Quyền bầu cử và Quyền ứng cử.
...
- Chủ đề 15 (do bị dư người nên lập nhóm mới, cô giao chủ đề mới luôn): Tìm hiểu nội dung về khái niệm, tác hại, ý nghĩa của việc phòng chống và trách nhiệm của công dân đối với tham nhũng.
